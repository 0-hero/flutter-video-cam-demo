...
enum YellowClassBottomNavigationBarType {
  /// The [YellowClassBottomNavigationBar]'s [YellowClassBottomNavigationBarItem]s have fixed width.
  fixed,

  /// The location and size of the [T4BottomNavigationBar] [YellowClassBottomNavigationBarItem]s
  /// animate and labels fade in when they are tapped.
  shifting,
}

class YellowClassBottomNavigationBar extends StatefulWidget {
  YellowClassBottomNavigationBar({
    Key key,
    @required this.items,
    this.onTap,
    this.currentIndex = 0,
    this.elevation = 8.0,
    YellowClassBottomNavigationBarType type,
    Color fixedColor,
  ...
  final List<YellowClassBottomNavigationBarItem> items;

  /// Called when one of the [items] is tapped.
  ///
  /// The stateful widget that creates the bottom navigation bar needs to keep
  /// track of the index of the selected [YellowClassBottomNavigationBarItem] and call
  /// `setState` to rebuild the bottom navigation bar with the new [currentIndex].
  final ValueChanged<int> onTap;

  /// The index into [items] for the current active [YellowClassBottomNavigationBarItem].
  final int currentIndex;

  /// The z-coordinate of this [YellowClassBottomNavigationBar].
  ///
  ...
  /// Defines the layout and behavior of a [YellowClassBottomNavigationBar].
  ///
  /// See documentation for [YellowClassBottomNavigationBarType] for information on the
  /// meaning of different types.
  final YellowClassBottomNavigationBarType type;
  ...
  /// The color of the [YellowClassBottomNavigationBar] itself.
  ///
  /// If [type] is [YellowClassBottomNavigationBarType.shifting] and the
  /// [items]s, have [YellowClassBottomNavigationBarItem.backgroundColor] set, the [item]'s
  /// backgroundColor will splash and overwrite this color.
  final Color backgroundColor;

  /// The size of all of the [YellowClassBottomNavigationBarItem] icons.
  ///
  /// See [YellowClassBottomNavigationBarItem.icon] for more information.
  final double iconSize;

  /// The color of the selected [YellowClassBottomNavigationBarItem.icon] and
  /// [YellowClassBottomNavigationBarItem.label].
  ///
  /// If null then the [ThemeData.primaryColor] is used.
  final Color selectedItemColor;

  /// The color of the unselected [YellowClassBottomNavigationBarItem.icon] and
  /// [YellowClassBottomNavigationBarItem.label]s.
  ///
  /// If null then the [TextTheme.caption]'s color is used.
  final Color unselectedItemColor;

  /// The size, opacity, and color of the icon in the currently selected
  /// [YellowClassBottomNavigationBarItem.icon].
  ///
  ...
  /// [YellowClassBottomNavigationBarItem.icon]s
  ///
  /// If this is not provided, the size will default to [iconSize], the color
  ...
  /// The [TextStyle] of the [YellowClassBottomNavigationBarItem] labels when they are
  /// selected.
  final TextStyle selectedLabelStyle;

  /// The [TextStyle] of the [YellowClassBottomNavigationBarItem] labels when they are not
  /// selected.
  final TextStyle unselectedLabelStyle;

  /// The font size of the [YellowClassBottomNavigationBarItem] labels when they are selected.
  ///
  ...
  /// The font size of the [YellowClassBottomNavigationBarItem] labels when they are not
  /// selected.
  ///
  ...
  /// Whether the labels are shown for the selected [YellowClassBottomNavigationBarItem].
  final bool showUnselectedLabels;

  /// Whether the labels are shown for the unselected [YellowClassBottomNavigationBarItem]s.
  ...
  static YellowClassBottomNavigationBarType _type(
    YellowClassBottomNavigationBarType type,
    List<YellowClassBottomNavigationBarItem> items,
  ) {
    if (type != null) {
      return type;
    }
    return items.length <= 3
        ? YellowClassBottomNavigationBarType.fixed
        : YellowClassBottomNavigationBarType.shifting;
  }
  ...
  static bool _defaultShowUnselected(YellowClassBottomNavigationBarType type) {
    switch (type) {
      case YellowClassBottomNavigationBarType.shifting:
        return false;
      case YellowClassBottomNavigationBarType.fixed:
        return true;
    }
    assert(false);
    return false;
  ...
  @override
  _YellowClassBottomNavigationBarState createState() =>
      _YellowClassBottomNavigationBarState();
}
...
class _BottomNavigationTile extends StatelessWidget {
  ...
  final YellowClassBottomNavigationBarType type;
  final YellowClassBottomNavigationBarItem item;
...
class _YellowClassBottomNavigationBarState
    extends State<YellowClassBottomNavigationBar>
  ...
  @override
  void didUpdateWidget(YellowClassBottomNavigationBar oldWidget) {
...
class _Circle {
  ...
  final _YellowClassBottomNavigationBarState state;
  final int index;
  final Color color;
...
class YellowClassBottomNavigationBarItem {
  /// Creates an item that is used with [YellowClassBottomNavigationBar.items].
  ///
  /// The argument [icon] should not be null and the argument [title] should not be null when used in a Material Design's [YellowClassBottomNavigationBar].
  const YellowClassBottomNavigationBarItem({
    @required this.icon,
    this.title,
    Widget activeIcon,
    this.backgroundColor,
  ...
  /// See also:
  ///
  ///  * [YellowClassBottomNavigationBarItem.icon], for a description of how to pair icons.
  final String activeIcon;

  /// The title of the item. If the title is not provided only the icon will be shown when not used in a Material Design [YellowClassBottomNavigationBar].
  final Widget title;

  /// The color of the background radial animation for material [YellowClassBottomNavigationBar].
  ///
  /// If the navigation bar's type is [YellowClassBottomNavigationBarType.shifting], then
  /// the entire bar is flooded with the [backgroundColor] when this item is
  /// tapped. This will override [YellowClassBottomNavigationBar.backgroundColor].
  ///
